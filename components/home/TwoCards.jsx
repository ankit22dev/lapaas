    ...
    return (
        <section className='section'>
            <div className='flex flex-col items-center justify-center h-full gap-6 section-wrapper md:flex-row md:gap-10 lg:gap-28'>
                <TitleImgCard
                    title={'Marketing'}
                    titleClassName='text-3xl md:text-4xl lg:text-5xl uppercase mb-8 font-bold text-black'
                    ...
                    className='border-8 cursor-pointer border-white bg-white text-center py-8 px-4 lg:py-10 lg:px-8 xl:h-[500px] xl:w-[450px] lg:h-[450px] lg:w-[400px] md:h-[350px] md:w-[300px]  h-[280px] w-[270px]'
                    onClick={() => {
