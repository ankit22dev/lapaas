    ...
    return (
        <section className="section">
            <div className='relative flex h-full px-6 py-8'>
                    ...
                    <div className="flex flex-col max-w-xl py-12">
                        <div className="items-center justify-center">
                            <h1 className="heading">
                                <div className="text-left">Transform Your Business with Lapaas</div></h1>
                        ...
                        <div class="mt-6">
                            <button type='button' className='w-auto mx-2 mt-2 red-btn' onClick={() => setSlide(true)}>astronaut</button>
                        </div>
                    </div>
                </div>
                <div
                ...
                >
                    <div className='relative hidden w-7/12 lg:block' id='heroImg'>
