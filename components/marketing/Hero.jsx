    ...
    return (
        <section className="section">
            <div className='relative flex h-full py-8 px-6'>
                ...
                >
                    <div className='relative w-7/12 hidden lg:block' id='heroImg'>
                        <Image src={astraunotincup} alt="HeroImg" className='w-full h-full bg-white' />
                    </div>
